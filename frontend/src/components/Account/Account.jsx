...
const Account = () => {
    ...
    return loading ||  userLoading === true ? (
        <Loader />
    ) : (
        <div className='account'>
            ...
            <div className="accountright">
                ...
                <Button variant='text' onClick={deleteProfileHandler} style={{ color: 'red', margin: '2vmax' }} disabled={deleteLoading}>Delete My Profile</Button>
                <Dialog
